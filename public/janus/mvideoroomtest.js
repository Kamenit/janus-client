...
var server = "https://" + "18.184.121.198" + ":8088/janus";
...
if (username==null){
	alert("prosledite username kao GET parametar!");
}
	...
	janus.attach(
		{
			...
			onremotetrack: function (track, mid, on, metadata) {
				...
				if ($('#remote' + slot).length == 0){
					$('#users').append('<div class="col-md-4"><div class="panel panel-default"><div class="panel-heading"> <h3 class="panel-title">Remote Video #'+slot+" user: "+feed.display+' <span class="label label-info hide" id="remote'+slot+'"></span></h3> </div> <div class="panel-body relative" id="videoremote'+slot+'"></div></div></div>');
				}
